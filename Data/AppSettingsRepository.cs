...
public class AppSettingsRepository
{
    ...
    public async Task<WhatsAppConfig> GetWhatsAppConfigAsync(IConfiguration configuration, bool includeSecret = false)
    {
        ...
        return new WhatsAppConfig
        {
            ...
            ReclamoInitialTemplateName = Get(nameof(WhatsAppConfig.ReclamoInitialTemplateName), configuration["WhatsApp:ReclamoInitialTemplateName"] ?? ""),
            ReclamoReminderTemplateName = Get(nameof(WhatsAppConfig.ReclamoReminderTemplateName), configuration["WhatsApp:ReclamoReminderTemplateName"] ?? ""),
            ReclamoCompleteTemplateName = Get(nameof(WhatsAppConfig.ReclamoCompleteTemplateName), configuration["WhatsApp:ReclamoCompleteTemplateName"] ?? ""),
            ReclamoApprovedPaymentsTemplateName = Get(nameof(WhatsAppConfig.ReclamoApprovedPaymentsTemplateName), configuration["WhatsApp:ReclamoApprovedPaymentsTemplateName"] ?? ""),
    ...
    public async Task SaveWhatsAppConfigAsync(WhatsAppConfig config, IConfiguration configuration)
    {
        ...
        var values = new Dictionary<string, string>
        {
            ...
            [nameof(config.ReclamoInitialTemplateName)] = config.ReclamoInitialTemplateName?.Trim() ?? "",
            [nameof(config.ReclamoReminderTemplateName)] = config.ReclamoReminderTemplateName?.Trim() ?? "",
            [nameof(config.ReclamoCompleteTemplateName)] = config.ReclamoCompleteTemplateName?.Trim() ?? "",
            [nameof(config.ReclamoApprovedPaymentsTemplateName)] = config.ReclamoApprovedPaymentsTemplateName?.Trim() ?? "",
